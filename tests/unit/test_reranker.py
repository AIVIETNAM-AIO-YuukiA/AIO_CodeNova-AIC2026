...
def test_rerank_logic(mock_score_batch, mock_load, tmp_path):
    ...
    results = [
        SearchResult(video_id="v1", video_name="vid1", frame_id="f1", frame_index=10, timestamp_sec=1.0, score=0.8, frame_path=str(valid_frame1)),
        SearchResult(video_id="v2", video_name="vid2", frame_id="f2", frame_index=20, timestamp_sec=2.0, score=0.85, frame_path="missing_frame.jpg"),
        SearchResult(video_id="v3", video_name="vid3", frame_id="f3", frame_index=30, timestamp_sec=3.0, score=0.7, frame_path=str(valid_frame2)),
    ]
